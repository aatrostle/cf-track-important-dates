...
class ImportantDatesControllerTest < ActionController::TestCase
  ...
  test "should create important_date" do
    assert_difference('ImportantDate.count') do
      post :create, important_date: { day: @important_date.day, description: @important_date.description, name: @important_date.name }
    end
  ...
  test "should update important_date" do
    put :update, id: @important_date, important_date: { day: @important_date.day, description: @important_date.description, name: @important_date.name }
    assert_redirected_to important_date_path(assigns(:important_date))
  end
